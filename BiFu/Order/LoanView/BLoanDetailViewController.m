...
@interface BLoanDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BLoanDetailViewController
...
-(void)setupConfirmButton{
    ...
    button.frame = CGRectMake(10, _bottomTableView.y+_bottomTableView.height+30, WIDTH-20, 40);
    button.backgroundColor = REDCOLOR;
    [button setTitle:@"确认收款" forState:UIControlStateNormal];
...
-(void)setupScrollView{
    ...
    self.scrollView.contentSize = CGSizeMake(WIDTH, 850);
...
-(void)reloadView{
    ...
    _confirmButton.frame = CGRectMake(10, _bottomTableView.bottom+30, WIDTH-20, 40);
