...
@interface RepayViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    CancelledCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cancelledCell" forIndexPath:indexPath];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    /*
     ＋页面
     */
    CancelledViewController *cancelVC=[[CancelledViewController alloc]init];
