...
@interface PRepaymentViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"待还款详情";
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    UITableViewCell *cell=[[UITableViewCell alloc]initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"prCell"];
