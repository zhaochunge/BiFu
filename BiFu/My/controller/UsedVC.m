...
@interface UsedVC ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *table;
@end

@implementation UsedVC
...
-(void)createTable{
    ...
    [self.table registerClass:[CardTableCell class] forCellReuseIdentifier:@"unusedReuse"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    CardTableCell *cell =[tableView dequeueReusableCellWithIdentifier:@"unusedReuse" forIndexPath:indexPath];
    ...
    [cell.useBtn setTitle:@"未使用" forState:(UIControlStateNormal)];
