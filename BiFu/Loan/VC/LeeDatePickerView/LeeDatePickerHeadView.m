...
-(void)setFrame:(CGRect)frame{
    ...
    [self.LineView setFrame:CGRectMake(self.bounds.size.width/4-self.bounds.size.width/8, 44, self.bounds.size.width/4, 1)];
}
-(void)initView{
    /*----开始时间---*/
...
-(void)startTimeTapAction{
    [UIView animateWithDuration:0.3 animations:^{
        self.LineView.frame=CGRectMake(self.bounds.size.width/4-self.bounds.size.width/8, 44, self.bounds.size.width/4, 1);
    }];
...
-(void)endTimeTapAction{
    [UIView animateWithDuration:0.3 animations:^{
        self.LineView.frame=CGRectMake(self.bounds.size.width/2+self.bounds.size.width/8, 44, self.bounds.size.width/4, 1);
    }];
