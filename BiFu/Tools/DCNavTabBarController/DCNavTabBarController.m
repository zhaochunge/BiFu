...
-(void)addSliderView
{
    ...
    UIView *slider = [[UIView alloc]initWithFrame:CGRectMake((self.btnW-30)/2,41,30, 3)];
...
{
    //滑动导航条
//    self.slider.frame = CGRectMake(scrollView.contentOffset.x / DCScreenW *self.btnW+(self.btnW-30)/2 , 41, 30, 3);
